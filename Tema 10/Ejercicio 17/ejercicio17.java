public class ejercicio17 {
  public static void main (String[] args) {
    ...
    System.out.println ("Hay " + miCarrito.numeroDeElementos () + " productos en la cesta");
    System.out.print ("El total asciende a ");
    System.out.println (String.format ("%.2f", miCarrito.importeTotal ()) + " euros");
